...
Valet av mikrokontroller kommer hamna på en \textit{ATMega} där typen kommer behöva specificeras när det minne och den snabbhet som krävs specificerats mer.


\subsection{Intermodulär kommunikation}
Den intermodulära kommunikationen kommer ske seriellt med ett av följande två gränssnitt: I2C eller SPI. Mest troligt I2C på grund av flera faktorer, bland annat på grund av den i teorin stödjer flera "masters" (mikrokontroller). \\
\bigskip
...
\begin{comment}
%Detta ska behandlas
Den intermodulära kommunikationen kommer ske på något av följande sätt:
\\

[1] Gemensam buss eller ej
\\

[2] Vilken som lagrar vad var
Styrmodulen lagrar och sköter all styrlogik samt reglering av styrning. Den kommunicerar med sensormodulen och när sensormodulen säger åt den att svänga gör den det.
\\

[3] Typ av buss, seriell, I2C-buss (Skicka åt båda håll, 2-vägs), osv
\\
