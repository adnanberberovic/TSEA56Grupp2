...
Roboten kommer bestå av ett flertal olika sensorer med avståndsmätning. Minst tre stycken mikroprocessorer (en per delmodul). Roboten kommer att ha fyra hjul som alla drivs av motorer som går att kontrollera individuellt.
...
PC:n används då data från roboten skall behandlas.
